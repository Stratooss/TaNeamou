...
function scoreSeriousArticle(article) {
  ...
  const timeMs = article.publishedAt
    ...
    : 0;
  return sourcesCount * 1_000_000_000_000 + timeMs; // δίνουμε πολύ μεγαλύτερο βάρος στα sites
}
...
Θεματικές:
- "politics_economy": Πολιτική, κυβέρνηση, κόμματα, εκλογές, βουλή, δημόσια διοίκηση,
  εξωτερική πολιτική, οικονομία, φόροι, μισθοί, συντάξεις, τράπεζες, ΔΝΤ, Ε.Ε. κτλ.
- "social": Κοινωνικά θέματα, εκπαίδευση, σχολεία, πανεπιστήμια, υγεία, νοσοκομεία,
  κοινωνικό κράτος, εργασιακά, απεργίες, διαμαρτυρίες, ατυχήματα, εγκλήματα,
  κοινωνικά προβλήματα (φτώχεια, στέγαση κ.λπ.).
- "world": Διεθνή θέματα, παγκόσμια γεγονότα, πόλεμοι, διεθνείς κρίσεις,
  διεθνής πολιτική, παγκόσμια οικονομία, γεγονότα σε άλλες χώρες.
- "other": οτιδήποτε δεν ταιριάζει ξεκάθαρα σε καμία από τις παραπάνω.

Πάντα πρέπει να διαλέγεις ΜΙΑ τιμή από: "politics_economy", "social", "world", "other".
`;
